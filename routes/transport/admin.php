...
Route::get('/vehicletype/priceform/{id}', function ($id) {
    return view('transport.admin.vehicletype.priceform', compact('id'));
});
//lostitem
...
//transport type
Route::view('/transporttype', 'transport.admin.transporttype.index');
Route::view('/transporttype/create', 'transport.admin.transporttype.form');
Route::get('/transporttype/{id}/edit', function ($id) {
    return view('transport.admin.transporttype.form', compact('id'));
});
