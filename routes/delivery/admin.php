...
//dispute
Route::view('/requestdispute', 'delivery.admin.dispute.index');
Route::view('/requestdispute/create', 'delivery.admin.dispute.form');
...
Route::view('/deliveryhistory', 'delivery.admin.history.requesthistory');
Route::view('/deliveryschedulehistory', 'delivery.admin.history.requestschedulehistory');
