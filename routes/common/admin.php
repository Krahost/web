...
//Unit
Route::view('/unit', 'common.admin.unit.index');
Route::view('/unit/create', 'common.admin.unit.form');
Route::get('/unit/{id}/edit', function ($id) {
    return view('common.admin.unit.form', compact('id'));
});
...
//Ticket Categories
Route::view('/ticket-categories', 'common.admin.ticketcategories.index');
Route::view('/ticket-categories/create', 'common.admin.ticketcategories.form');
Route::get('/ticket-categories/{id}/edit', function ($id) {
    return view('common.admin.ticketcategories.form', compact('id'));
});

//Ticket
Route::view('/tickets', 'common.admin.tickets.index');
Route::get('/view-tickets/{id}', function ($id) {
    return view('common.admin.tickets.ticket-chat', compact('id'));
});
