...
Route::view('/tickets', 'common.provider.tickets.index');
Route::view('/closed-tickets', 'common.provider.tickets.closed_index');
Route::view('/new-tickets', 'common.provider.tickets.form');

Route::get('/view-tickets/{id}', function ($id) {
    return view('common.provider.tickets.ticket-chat', compact('id'));
});
