...
class StartedComponent extends React.Component {
    ...
    handleOtp = id => {
        ...
        if (otp != "") {
            this.handleUpdateStatus(id, 'ARRIVED');
        } else {
                    ...
                    {delivery && <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0">
                        ...
                        <div className="actions col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            {delivery.status == "PROCESSING" && this.props.request.status == "ARRIVED" && this.props.request.payment_by == "RECEIVER" ?
                                ...
                                : ''}
                            {delivery.status == "PROCESSING" && this.props.request.status == "STARTED" && getSiteSettings().delivery.otp == "1" && this.props.request.created_type != "ADMIN" ?
                                <a id="arrived" className="btn btn-primary btn-md mr-2" data-toggle="modal" onClick={this.handleOtpModal} >Arrived <i className="fa fa-check" aria-hidden="true"></i></a>
                                :''}

                            {delivery.status == "PROCESSING" && this.props.request.status == "STARTED" && getSiteSettings().delivery.otp == "0" && this.props.request.created_type != "ADMIN" ?
                               <a id="arrived" className="btn btn-primary btn-md mr-2" onClick={() => { this.handleUpdateStatus(delivery.id, 'ARRIVED') }}>Arrived <i className="fa fa-check" aria-hidden="true"></i></a>
                                : ''}
                            {(delivery.status == "STARTED" ) ? <a id="arrived" className="btn btn-primary btn-md mr-2" onClick={() => { this.handleUpdateStatus(delivery.id, 'DROPPED') }} >Reached Delivery Location <i className="fa fa-check" aria-hidden="true"></i></a> : ""}
