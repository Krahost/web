                            ...
                            {requests.map((request) =>
                                <div key={request.id} onClick={ this.handleClick.bind(this, request) } className="bg-white m-lr-20 shadow-sm">
                                    ...
                                    <div className="p-2">
                                        ...
                                        <a className=" m-2 c-pointer btn btn-red" onClick={ this.handleOrderCancel.bind(this, request) }  data-toggle="modal" data-target="#cancelModal">Cancel <i className="material-icons">cancel</i></a></span>
                            ...
                            <div className="modal-dialog modal-lg">
                                <div className="modal-content">
                                    ...
                                    <div className="form-row mb-3">
                                       ...
                                       <table className="table accept-table">
                                        <thead>
                                            <tr>
                                                <th>Sno</th>
                                                <th>Product Name</th>
