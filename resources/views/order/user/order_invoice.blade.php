            ...
            <div class="widget-body">            
                  <div class="row">
                     ...
                     <form method="post">
                        ...
                        <h6 class="mb-3 pt-3"><span>Booking Id</span> : <span class="txt-green" id="bookingId"></span></h6>
                        ...
                        <h6 class="mb-3 pt-3" ><span class="txt-green" id="deliverytime"></span></h6>
...
<script type="text/javascript">
   ...
   function deliveryTime(){
      $.ajax({
         url: getBaseUrl() + "/user/delivery-time/{{$id}}",
         type: "get",
         processData: false,
         contentType: false,
         secure: false,
         ...
         success: (response, textStatus, jqXHR) => {
               var data = parseData(response); 
               $("#deliverytime").text("Food Will Be Delivered "+data.responseData);
            ...
            if((data.responseData).length != 0) { 
              ...
              if(order_list.status == 'STORECANCELLED') {
               ...
               if(order_list.status=='STARTED' || order_list.status=='PICKEDUP' || order_list.status=='REACHED' ){
                  ...
                  if(order_list.order_type != 'TAKEAWAY'){
                     deliveryTime();
                     time = setInterval(deliveryTime, 300000);
