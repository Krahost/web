        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    ...
                    @permission('order-dispute-create')
                ...
                <thead>
                    <tr>
                            ...
                            @permission('order-dispute-status')                     
    ...
    table = table.DataTable( {
        ...
        "columns": [
            ...
            { "data": "dispute_type", render: function (data, type, row) {
                console.log(data);
                if(data =="user"){
                    return row.user?row.user.currency_symbol+row.refund_amount:row.request.currency+'0';
                }
                else if(data == "provider")
                {
                    return row.provider?row.provider.currency_symbol+row.refund_amount:row.request.currency+'0';
                }
                else{
                    return row.refund_amount?row.request.currency+row.refund_amount:row.request.currency+'0';
                }
               }
            },
            ...
            { "data": "id", render: function (data, type, row) {
                ...
                return "@permission('order-dispute-edit')<button data-id='"+data+"' class='btn btn-block btn-success edit'>Edit</button>@endpermission";
               }
            }
