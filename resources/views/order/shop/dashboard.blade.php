        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card dashboard_card">
                <div class="card-header card-header-warning card-header-icon">
                    ...
                    <p class="card-category stats-small__label text-uppercase">Orders Received</p>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card dashboard_card">
                <div class="card-header card-header-success card-header-icon">
                    ...
                    <p class="card-category stats-small__label text-uppercase"><b>Orders Delivered</b></p>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card dashboard_card">
                <div class="card-header card-header-danger card-header-icon">
                    ...
                    <p class="card-category stats-small__label text-uppercase">Today Earnings</p>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card dashboard_card">
                <div class="card-header card-header-info card-header-icon">
                    ...
                    <p class="card-category stats-small__label text-uppercase">Wallet Balance</p>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0">Products Sales</h6>
                </div>
                    ...
                    <table class="table table-hover mb-0">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th scope="col" class="border-0">Delivery Person</th>
