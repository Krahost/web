...
<div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <span class="text-uppercase page-subtitle">Shop</span>
        ...
        <div class="col-md-12">
            ...
            <form class="validateForm" files="true">
                ...
                <div class="form-row">
                    ...
                    <br>
                   <button type="submit" class="btn btn-accent">Update Shops</button>
    ...
    $('#everyday').change(function() {
     ...
     if($("input[name=id]").length){
        ...
        success:function(response){
            ...
            console.log(data.store_type_id);
    ...
    function loadstorecategory(){
     ...
     $('.validateForm').validate({
		...
		submitHandler: function(form) {
            ...
            data.append( 'iso2', $('.phone').intlTelInput('getSelectedCountryData').iso2 );
