...
<html class="no-js h-100" lang="en">
   ...
   <!-- <div class="loader-container">
                  ...
                  <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
                     ...
                     <ul class="navbar-nav border-left flex-row ">
                        ...
                        <li class="nav-item notifications" >
                           <a style="cursor: pointer" id="notification" class="nav-link">
                              <!-- <i class="material-icons">&#xE7F4;</i> -->
                              <i class="fa fa-bell"></i>
                              <span style="display: none" class="count notification_count" ></span>
                           </a>
                        </li>
      ...
      <script>    
         ...
         window.SERVICE_WORKER = "{{ asset('service-worker.js')}}"
   ...
   $(document).ready(function() {
              ...
              $.ajax({
                  ...
                  success: (response, textStatus, jqXHR) => {
                    ...
                    if(data.responseData.total != 0 ) {
                     ...
                     if( data.responseData.total_count != 0 || data.responseData.total_count != "") {
      ...
      <script src="{{ asset('assets/layout/js/enable-shop-push.js')}}"></script>
