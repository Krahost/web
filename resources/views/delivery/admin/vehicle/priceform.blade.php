                ...
                <div class="tab-content pricing-nav nav-wrapper" id="nav-tabContent">
                    ...
                    <!-- Pricing for Country -->
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="feFirstName">Base Weight (0 kgs)</label>
                                        <input class="form-control" type="number" value="" name="weight" id="weight" placeholder="Base Weight" min="0">
                                        <span class="txt_clr_4"><i> BW (Base Weight)</i></span>
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="feFirstName">Unit Weight Pricing (0 Kg)</label>
                                        <input class="form-control" type="number" value="" name="weight_price" id="weight_price" placeholder="Unit Weight Price" min="0">
                                        <span class="txt_clr_4"><i> PKgs (Per Kgs), TKgs (Total Kgs)</i></span>
                                    </div>
                              
                                    <div class="form-group col-md-6">
                                        <label for="feFirstName">Unit Distance Pricing (0 Kms)</label>
                                        <input class="form-control" type="number" value="" name="price" id="price" placeholder="Unit Distance Price" min="0">
