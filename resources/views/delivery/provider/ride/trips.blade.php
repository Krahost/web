      ...
      <div id="toaster" class="toaster"></div>
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-10 wrapper">
               <div class="col-md-12 col-lg-12 col-sm-12 p-0 table-responsive-sm delivery-history">
                  <table id="delivery_grid" class="table  table-striped table-bordered w-100">
                     <thead>
                        <tr>
            ...
            <div class="modal-dialog min-70vw">
                  <div class="modal-content">
                     ...
                     <div class="modal-header">
                        <h4 class="modal-title m-0">Delivery Details</h4>
                        ...
                        <div class="col-md-6 float-right">
                           ...
                           <div class="trip-user">
                              ...
                              <div class="user-right">
                                 <h5><span class ="customer_name"></span></h5>
...
@parent
   ...
   <script>
      ...
      $('#DELIVERY').change(function(){
         if($(this).is(":checked")) {
            window.location.replace('/provider/trips/delivery');
         } 
      });
   //For Dispute Details
   $.ajax({
      ...
      trips_table = trips_table.DataTable( {
        ...
        "ajax": {
            ...
            data: function(data){
                ...
                var info = $('#delivery_grid').DataTable().page.info();
                delete data.columns;
              ...
              for (var i in result.deliveries) {
               ...
               var deliveryLocations = '';
                $.each(result.deliveries,function(key,value){
                  ...
                  deliveryLocations += value.d_address+' ,';
                  if(payment != null){
                ...
                $('.to_address').text(deliveryLocations); 
