        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    ...
                    @permission('add-sub-service-categories')
        ...
        "columns": [
           ...
           /* { "data": "picture", render: function (data, type, row) {
            ...
            { "data": "service_subcategory_status" ,render: function (data, type, row) {
                if(data == 1){
                        return "@permission('sub-service-categories-status')<label class='switch'><input type='checkbox' class='status_enable switch-warning' checked data-id='"+row.id+"' data-value='"+row.service_subcategory_status+"'> <span class='slider round'></span></label>@endpermission"

                   }else{
                    return "@permission('sub-service-categories-status')<label class='switch'><input type='checkbox' class='status_enable'  data-id='"+row.id+"' data-value='"+row.service_subcategory_status+"'> <span class='slider round'></span></label>@endpermission"
                   }
            }
            },
            ...
            var button='@permission("edit-sub-service-categories")<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button>'+
                   '<ul class="dropdown-menu">';
                    if({{Helper::getDemomode()}} != 1){
                   button +='<li><a href="javascript:;" data-id="'+data.id+'" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li>';
                    }
                    button +='</ul> </li></div>@endpermission';
                 return  button;
