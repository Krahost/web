        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    ...
                    @permission('add-service-categories')
    ...
    table = table.DataTable( {
        ...
        "columns": [
            ...
            { "data": "service_category_status" ,render: function (data, type, row) {
                if(data == 1){
                        return "@permission('service-categories-status')<label class='switch'><input type='checkbox' class='status_enable switch-warning' checked data-id='"+row.id+"' data-value='"+row.service_category_status+"'> <span class='slider round'></span></label>@endpermission"

                   }else{
                    return "@permission('service-categories-status')<label class='switch'><input type='checkbox' class='status_enable'  data-id='"+row.id+"' data-value='"+row.service_category_status+"'> <span class='slider round'></span></label>@endpermission"
                   }
            }
            },
            ...
            var button='@permission("edit-service-categories ")<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button>'+
