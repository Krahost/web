        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    ...
                    @permission('service-dispute-create')
                ...
                <thead>
                    <tr>
                            ...
                            @permission('service-dispute-status')                        
...
$(document).ready(function() {
    ...
    var url = getBaseUrl() + "/admin/service/requestdispute";
    ...
    table = table.DataTable( {
        ...
        "columns": [
            ...
            { "data": "id", render: function (data, type, row) {
                ...
                return "@permission('service-dispute-edit')<button data-id='"+data+"' class='btn btn-block btn-success edit'>Edit</button>@endpermission";
               }
            }
