                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-2">
                        <img id="image_preview_container" src="{{ asset('public/image/image-preview.png') }}"
                            alt="" class="d-none" style="max-height: 150px;">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
...
$('#file').change(function(){
       ...
       messages: {
        ...
        success: function(label) {
         ...
         submitHandler: function (form) {
            ...
            $.ajax({
                type:'POST',
                url: getBaseUrl() + "/provider/new-ticket",
                data: data,
                processData: false,
                contentType: false,
                headers: {
                ...
                success:function(data){
                    ...
                    hideInlineLoader();
                    setTimeout(function(){
                        window.location.replace("{{ url('provider/tickets') }}");
    ...
    $('#admin_service').change(function(){
        ...
        {
            $.ajax({
                url:  getBaseUrl() + "/provider/ticket-category/"+admin_service,
                type: "GET",
                headers: {
                    Authorization: "Bearer " + getToken("provider")
                    },
