...
<section class="content-box ticketContentBox" id="Contact">
    ...
    <div class="container">
        <div class="ticketMenu">
            <ul>
                <li><a class="active" href="{{ url('provider/tickets') }}">Open Tickets</a></li>
                <li><a href="{{ url('provider/closed-tickets') }}">Closed Tickets</a></li>
...
$(document).ready(function() {
    table = table.DataTable( {
        ...
        "ajax": {
            "url": getBaseUrl() + "/provider/my_tickets?&status=0&type=PROVIDER",
            "type": "GET",
