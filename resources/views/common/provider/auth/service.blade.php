        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-10 wrapper">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 p-0 tranport">
                ...
                <form class="transportForm  col-md-12 col-lg-12 col-sm-12 p-0 tranport">
                    <div class="col-md-12 col-sm-12 pro-form vechile-form d-none vehicle_form_container">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 p-0 orders d-none">
                ...
                <form class="orderForm  col-md-12 col-sm-12 pro-form order_vechile-form d-none">
                    <div class="col-md-12 col-sm-12 pro-form order_vechile-form d-none order_form_container">
                        <div class="">
                            <h5 class="word-breakwrap"><strong>@lang('provider.add_vehicle')</strong></h5>
                            <div class="row p-0">
                                <div class="col-md-12 col-sm-12 col-xl-6">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 p-0 delivery">
                ...
                <form class="deliveryForm  col-md-12 col-lg-12 col-sm-12 p-0 delivery">
                    <div class="col-md-12 col-sm-12 pro-form delivery-vechile-form d-none delivery_form_container">
                        <h5 class="word-breakwrap"><strong>@lang('provider.add_vehicle')</strong></h5>
...
<script>
    ...
    $('body').on('click', '#myservices', function() {
        ...
        servicestatus('TRANSPORT',active_id,$('.service-box[data-value="' + $('.category_id').val() + '"]').find('input[name=transport_status]').is(':checked'));

        if ($('.service-box[data-value="' + $('.category_id').val() + '"]').find('input[name=transport_status]').is(':checked')) {

            $('.transport_status').show();
    ...
    $('body').on('click', '#mydeliveries', function() {
        ...
        $('.category_id').val(active_id);
        servicestatus('DELIVERY',active_id,$('.service-box[data-value="' + $('.category_id').val() + '"]').find('input[name=transport_status]').is(':checked'));
       
        if ($('.service-box[data-value="' + $('.category_id').val() + '"]').find('input[name=transport_status]').is(':checked')) {
            $('.delivery_form_container').show();
        var servicelist = service_list[active_id];
        html = '<option value="">--Please Select --</option>';
        if (servicelist.length != 0) {
            $.each(servicelist, function(k, v) {
    ...
    $('body').on('click', '.order_service-box', function() {
        ...
        servicestatus('ORDER',active_id,$('.order_service-box[data-value="' + $('.category_id').val() + '"]').find('input[name=transport_status]').is(':checked'));
    ...
    function servicestatus(type,active_id,obj) {
        ...
        var vechile_id =0;
        if (transportdata[active_id])
            vechile_id = transportdata[active_id].providervehicle.id;
        
        $.ajax({
            url: getBaseUrl() + "/provider/services_status/"+vechile_id+"?admin_service="+type+"&status="+status,
            type: "get",
            headers: {
                Authorization: "Bearer " + getToken("provider")
            },
            success:function(data){
                var servicestatus = data.responseData;
                ...
                if (response.length != 0) {
                    ...
                    for (var i in response) {
                        ...
                        $.each(response[i]['name'], function(key, value) {
                            ...
                            var checked = '';
                            if (response[i]["provider_service_id"][j] && response[i]["status"][j] != "INACTIVE") {
                                checked = 'checked';
                            }
