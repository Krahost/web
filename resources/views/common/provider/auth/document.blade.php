    ...
    $.ajax({
        ...
        success: (data, textStatus, jqXHR) => { 
            ...
            for (var i in response) {
                ...
                if(type == "SERVICE" && response[i].service_category)
                {
                   
                    html += `<h4><strong>` +response[i].service_category.service_category_name;
                    if(response[i].servicesub_category)
                    {
                      html += ` - `+response[i].servicesub_category.service_subcategory_name ;
                    }
                     html += `</strong></h4><h6><strong>Upload ` + response[i].name + `</strong></h6>
