        ...
        "columns": [
           ...
           /* { "data": "id" ,render: function (data, type, rows) {
            ...
            { "data": "id", render: function (data, type, row) {
                   ...
                   @permission("edit-city")<li><a href="javascript:;" data-id="`+data+`" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li>@endpermission
                    @permission("delete-city")<li><a href="javascript:;" data-id="`+data+`" class="dropdown-item delete"><i class="fa fa-trash"></i>&nbsp;Delete</a> </li>@endpermission
                    </ul> </li></div>`;
                 return  button;
