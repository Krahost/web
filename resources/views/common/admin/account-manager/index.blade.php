            ...
            <div class="card card-small">
                ...
                <div class="col-md-12">
                    <div class="note_txt">
                        ...
                        @endif
                        @permission('account-manager-create')
    ...
    table = table.DataTable( {
        ...
        "columns": [
            ...
            { "data": "id", render: function (data, type, row) {
                ...
                return "@permission('account-manager-edit')<button data-id='"+data+"' class='btn btn-block btn-success edit'>Edit</button> @endpermission @permission('account-manager-delete')<button data-id='"+data+"' class='btn btn-block btn-danger delete'>Delete</button>@endpermission";
            }}
