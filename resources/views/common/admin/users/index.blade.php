        ...
        "columns": [
            ...
            { "data": function (data, type, row) {
                ...
                if(data.status ==1){
                   ...
                   button +='@permission('user-edit')<li><a href="javascript:;" data-id="'+data.id+'" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li> @endpermission @permission('user-delete')<li><a href="javascript:;" data-id="'+data.id+'" class="dropdown-item logs"><i class="fa fa-database"></i> Logs</a> </li>@endpermission<li><a href="javascript:;" data-id="'+data.id+'" class="dropdown-item wallet"><i class="fa fa-google-wallet"></i> Wallet Details</a> </li>';
