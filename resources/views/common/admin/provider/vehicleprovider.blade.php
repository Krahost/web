  ...
  if(model_name=="ORDER"){
    ...
    $('.img1').attr('src', vechile_details[vechile_id].picture1);
        if(vechile_details[vechile_id].status =='ASSESSING'){
            ...
            $("#delete_vechile").html(`<button data-id=`+vechile_details[vechile_id].id+` data-value='' class='btn btn-danger btn-large doc-delete pull-left delete' style = "margin-right:20px;">Remove</button>`);
