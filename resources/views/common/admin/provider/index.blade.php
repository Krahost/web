		...
		<div class="modal-content">
			<div class="modal-container">
                ...
                <div class="popup-card-content-in">
                    ...
                    <form class="validateForms" id="vehicles_reject">

                        <input type="hidden" id="vechile_id" name="vechile_id" value="">
                         <input type="hidden" id="vechile_type" name="vechile_type" value="">
                        ...
                        <div class="form-row">
                         ...
                         <a  class="btn btn-success btn-large vehicle_rejects ">Submit </a>
                        <a  class="btn btn-danger btn-large  vechileCancel pull-right documentcancel">Cancel </a>


                    </form>
                    <div class="form_pad" id="vehicle_details">
                        <div class="form-row">
            ...
            { "data": "activation_status" ,render: function (data, type, row)
                {
                    ...
                    }else if(row.is_document != 1){
                       return "<span class='badge badge-pill badge-info'>Document Pending</span>"
                    }
                    else if(row.is_bankdetail != 1){
                       return "<span class='badge badge-pill badge-info'>Bank Details Pending</span>"
                    }else{
                         return "<span class='badge badge-pill badge-primary'>Verification Pending</span>"
                    }
                }
            },
            { "data": function (data, type, row) {
               // console.log(data);
                ...
                var button='<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button>'+
                       ...
                       if(data.status=="APPROVED"){
                            button +='@permission('provider-status')<li > <a class="dropdown-item status" data-id="'+data.id+'" data-value="'+status+'"  href="javascript:;"><i class="fa fa-plus" aria-hidden="true" title="Status">&nbsp;'+status+'</i></a></li>@endpermission';
                        }


                        if({{Helper::getDemomode()}} != 1){
                        button +='@permission('provider-edit')<li><a href="javascript:;"  data-id="'+data.id+'" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li> @endpermission <li><a href="javascript:;"  data-id="'+data.id+'" class="dropdown-item add_amount"><i class="fa fa-plus"></i>Add Amount</a> </li><li><a href="javascript:;" data-id="'+data.id+'" class="dropdown-item wallet"><i class="fa fa-google-wallet"></i> Wallet Details</a> </li><li><a href="javascript:;" data-cityid="'+data.city_id+'" data-zoneid="'+data.zone_id+'" data-id="'+data.id+'" class="dropdown-item document"><i class="fa fa-thumbs-up"></i>Approval</a> </li><li><a href="javascript:;" data-id="'+data.id+'" class="dropdown-item logs"><i class="fa fa-database"></i> Logs</a> </li>';
                        }
                        button +='</ul> </li></div>';
                     return  button;
