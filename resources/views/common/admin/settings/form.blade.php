                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control" type="text" value="@if(Helper::getDemomode() == 0){{ Helper::getSettings()->site->browser_key  }}@endif" name="browser_key" required id="browser_key" placeholder="@lang('admin.setting.browser_key')">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control" type="text" value="@if(Helper::getDemomode() == 0){{ Helper::getSettings()->site->server_key  }}@endif" name="server_key" required id="server_key" placeholder="@lang('admin.setting.server_key')">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control" type="text" value="@if(Helper::getDemomode() == 0){{ Helper::getSettings()->site->android_key  }}@endif" name="android_key" required id="android_key" placeholder="@lang('admin.setting.android_key')">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control" type="text" value="@if(Helper::getDemomode() == 0){{ Helper::getSettings()->site->ios_key  }}@endif" name="ios_key" required id="ios_key" placeholder="@lang('admin.setting.ios_key')">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group hidesms twilInputs">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control" type="text" value="@if(Helper::getDemomode() == 0){{ Helper::getSettings()->site->sms_account_sid  }}@endif" name="sms_account_sid" required id="sms_account_sid" placeholder="@lang('admin.setting.twilio_settings.sms_twilio_sid')">
                            </div>
                        </div>
                        <div class="form-group hidesms twilInputs">
                            <label for="sms_auth_token" class="col-xs-3 col-form-label">@lang('admin.setting.twilio_settings.sms_auth_token')</label>
                            <div class="col-xs-9">
                                <input class="form-control" type="text" value="@if(Helper::getDemomode() == 0){{ Helper::getSettings()->site->sms_auth_token  }}@endif" name="sms_auth_token" required id="sms_auth_token" placeholder="@lang('admin.setting.twilio_settings.sms_auth_token')">
                            </div>
                        </div>
                        <div class="form-group hidesms twilInputs">
                            <label for="sms_from_number" class="col-xs-3 col-form-label">@lang('admin.setting.twilio_settings.sms_from_number')</label>
                            <div class="col-xs-9">
                                <input class="form-control" type="text" value="@if(Helper::getDemomode() == 0){{ Helper::getSettings()->site->sms_from_number  }}@endif" name="sms_from_number" required id="sms_from_number" placeholder="@lang('admin.setting.twilio_settings.sms_from_number')">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="delivery" class="row setup-content edu_form form_bdy">
                <div class="col-xs-12">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control number" type="text" value="{{ @Helper::getSettings()->delivery->user_select_timeout  }}" name="delivery_user_select_timeout" required id="delivery_user_select_timeout" placeholder="User Timeout">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control number" type="text" value="{{ Helper::getSettings()->delivery->provider_select_timeout  }}" name="delivery_provider_select_timeout" required id="provider_accept_timeout" placeholder="Provider Timout">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control number" type="text" value="{{ Helper::getSettings()->delivery->provider_search_radius  }}" name="delivery_provider_search_radius" required id="ride_search_radius" placeholder="Provider Search Radius">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <select name="delivery_unit_measurement" class="form-control">
                                    <option value="Kms" {{ Helper::getSettings()->delivery->unit_measurement == 'Kms' ? 'selected' : '' }}>Kms</option>
                                    <option value="Miles" {{ Helper::getSettings()->delivery->unit_measurement == 'Miles' ? 'selected' : '' }}>Miles</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <div class="custom-control custom-toggle">
                                <input {{ Helper::getSettings()->delivery->manual_request == '1' ? 'checked value="1"' : ''}} type="checkbox" id="delivery_manual_request" name="delivery_manual_request" class="custom-control-input" value='1' >
                                <label class="custom-control-label" for="delivery_manual_request"></label>
                            </div>
                        </div>
                        <!-- @if(Helper::getSettings()->delivery->broadcast_request == '1')
                        <div class="form-group">
                            <label for="broadcast_request">{{ __('Broadcast') }}</label>
                            <br>
                            <div class="custom-control custom-toggle">
                                <input {{ Helper::getSettings()->delivery->broadcast_request == '1' ? 'checked value="1"' : ''}} type="checkbox" id="broadcast_request" name="broadcast_request" class="custom-control-input" value='1'>
                                <label class="custom-control-label" for="broadcast_request"></label>
                            </div>
                        </div>
                        @endif -->
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <div class="custom-control custom-toggle">
                                <input {{Helper::getSettings()->delivery->otp == '1' ? 'checked' : ''}} type="checkbox" value="1" id="customToggle_dotp" name="delivery_otp"  class="custom-control-input" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <input class="form-control" type="text" value="{{Helper::getSettings()->delivery->booking_prefix}}" id="delivery_booking_prefix" name="delivery_booking_prefix"  placeholder="Booking ID Prefix">
                            </div>
                        </div>
                        @if(Helper::getDemomode() == 0)
                        <button class="btn btn-success nextBtn btn-lg" type="submit">{{ __('Submit') }}</button>
