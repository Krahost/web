...
<div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">{{ __('PeakHour') }}</span>
            <h3 class="page-title">{{ __('PeakHour') }} {{ __('List') }}</h3>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0 pull-left">{{ __('PeakHour') }}</h6>
                    @permission('add-peak-type')
                    <a href="javascript:;" class="btn btn-success pull-right add"><i class="fa fa-plus"></i> {{ __('Add New') }} {{ __('PeakHour') }}</a>
                    @endpermission
                </div>
    ...
    table = table.DataTable( {
        ...
        "columns": [
            ...
            { "data": "id", render: function (data, type, row) {
                ...
                return "@permission('edit-peak-type')<button data-id='"+data+"' class='btn btn-block btn-success edit'>Edit</button>@endpermission @permission('delete-peak-type')<button data-id='"+data+"' class='btn btn-block btn-danger delete'>Delete</button>@endpermission";
            }}
