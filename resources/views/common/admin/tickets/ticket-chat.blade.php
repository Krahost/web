        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom pl-0">
                    <h6 class="m-0 pull-left pb-2">{{ __('My Tickets') }}</h6>
                </div>
                <div class="col-md-12">
                    <div class="note_txt">
                    </div>
                        ...
                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <textarea class="form-control" id="description" name="description" rows="6" placeholder="Your message..." required  autocomplete="off"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                         ...
                                                         <div class="col-md-12 mb-2">
                                                            <img id="image_preview_container" src="{{ asset('public/image/image-preview.png') }}" class="d-none " 
                            ...
                            <div class="col-md-4">
                                <div class="chatContentRight">
                                    <a href="{{ URL::previous() }}" role="button" class="btn btn-primary pull-right">Back</a>
                             <br>
                                    <div class="ticketStatus">
                                        <span class="st-tl">Status</span>
                                        <span class="current" id="status">Open</span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$('#file').change(function(){
    ...
    $.ajax({
        url: getBaseUrl() + "/admin/ticketComments"+id,
        type: "GET",
        headers: {
       ...
       messages: {
        ...
        success: function(label) {
         ...
         submitHandler: function (form) {
            ...
            $.ajax({
                url: getBaseUrl() + "/admin/newcomment",
                type: "post",
                data: data,
                processData: false,
                contentType: false,
                ...
                success:function(data){
                    ...
                    hideInlineLoader();
                    setTimeout(function(){
                        window.location.replace("{{ url('admin/view-tickets/') }}"+id);
