               ...
               // console.log(data);
                ...
                if({{Helper::getDemomode()}} != 1){
                    var button='<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button>'+
                           ...
                           button +='@permission('zone-edit')<li><a href="javascript:;" data-id="'+data.id+'" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li>@endpermission @permission('zone-delete')<li><a href="javascript:;" data-id="'+data.id+'" class="dropdown-item delete"><i class="fa fa-trash"></i> Delete</a> </li>@endpermission';
                            button +='</ul> </li></div>';
                         return  button;
                }
