...
$(document).ready(function() {
    ...
    table = table.DataTable( {
        ...
        "columns": [
            ...
            { "data": "transaction_id" },
            { "data": "payroll_type" },
          @permission('payroll-status')  { "data": "status"},  @endpermission
            ...
            var button=`<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button>`+
                   `<ul class="dropdown-menu">`;
                    if({{Helper::getDemomode()}} != 1){
                        ...
                        button +=`@permission('payroll-delete')<li><a href="javascript:;" data-id="`+data.transaction_id+`" class="dropdown-item delete"><i class="fa fa-trash"></i> Delete</a> </li>@endpermission @permission('zone-downlod')
                        <li><a href="`+getBaseUrl() + `/admin/payrolls/download/`+data.transaction_id+`" data-id="`+data.transaction_id+`" class="dropdown-item "><i class="fa fa-database"></i> Download</a> </li>@endpermission`;
                    }
                    button +=`</ul> </li></div>`;
                 return  button;  
