    ...
    table = table.DataTable( {
        ...
        "columns": [
            ...
            { "data": "status" ,render: function (data, type, row) {
                // console.log(data);
                if(data ==1){
                        return "@permission('country-status')<label class='switch'><input type='checkbox' class='status_enable switch-warning' checked data-id='"+row.id+"' data-value='"+row.status+"'> <span class='slider round'></span></label>@endpermission"
                   }else{
                    return "@permission('country-status')<label class='switch'><input type='checkbox' class='status_enable'  data-id='"+row.id+"' data-value='"+row.status+"'> <span class='slider round'></span></label>@endpermission"
                   }
                }
            },
            { "data": function (data, type, row) {
                ...
                if(data.status ==1){
                    ...
                    var button='<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button>'+
                           ...
                           button +='@permission("edit-country")<li><a href="javascript:;" data-id="'+data.id+'" data-country_id="'+data.country_id+'" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li>@endpermission @permission("country-bank-form")<li><a href="javascript:;" data-id="'+data.country_id+'" class="dropdown-item bankform"><i class="fa fa-address-card"></i>&nbsp;Bank Form</a> </li>@endpermission';
                            button +='</ul> </li></div>';
                         return  button;
