        ...
        "columns": [
            ...
            { "data": "id", render: function (data, type, row) {
                if(data>5 && {{Helper::getDemomode()}} != 1){
                    ...
                    var button='<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button><ul class="dropdown-menu">@permission('role-edit')<li><a href="javascript:;" data-id="'+data+'" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li>@endpermission @permission('role-delete')<li><a href="javascript:;" data-id="'+data+'" class="dropdown-item delete"><i class="fa fa-trash"></i>&nbsp;Delete</a> </li> @endpermission</ul> </li></div>';
                 return  button;
                }
                else{
