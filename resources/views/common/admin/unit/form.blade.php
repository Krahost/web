...
<div class="row">
    <div class="col-md-12">
        <div class="card-header border-bottom">
            ...
            @endif
            <h6 class="m-0"style="margin:10!important;">{{$action_text}} {{ __('Unit') }}</h6>
        </div>
        ...
        <div class="popup-card-content-in">
            <form class="validateForm">
               ...
               {{-- @if(count(Helper::getServiceList())> 1)
                ...
                <br>
                <button type="submit" class="btn btn-accent frontend_image">{{$action_text}} {{ __('Unit') }}</button>
...
$(document).ready(function()
{
     ...
     if($("input[name=id]").length){
        ...
        var url = getBaseUrl() + "/admin/unit"+id;
        setData( url );
     }
