    ...
    <ul class="nav flex-column">
        ...
        @permission('statements')
            ...
            <li class="nav-item">
                ...
                <div id="collapse3" class="collapse in">
                    @permission('overall-transport-statements')
                    @if(Helper::checkService('TRANSPORT'))
                    ...
                    @endif
                    @endpermission
                    @permission('overall-service-statements')
                    @if(Helper::checkService('SERVICE'))
                    ...
                    @endif
                    @endpermission
                    @permission('overall-order-statements')
                    @if(Helper::checkService('ORDER'))
        ...
        <li class="nav-item">
          ...
          <div id="collapse6" class="collapse in" style="">
            <a class="nav-link" href="{{ url('/admin/transporttype') }}">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ url('admin/deliveryhistory')}}">
                <i class="material-icons">history</i>
                <span>{{ __('Delivery History') }}</span>
             </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ url('admin/deliveryschedulehistory')}}">
                <i class="material-icons">alarm</i>
        ...
        @permission('cms-pages')
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/ticket-categories')}}">
