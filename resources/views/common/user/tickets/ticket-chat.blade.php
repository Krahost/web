            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="chatContentRight">
                        <!-- <div class="backTicket mb-3"><a href=""><button class="btn btn-default" type="submit">Back</button></a></div> -->
...
$('#file').change(function(){
    ...
    $.ajax({
        url: getBaseUrl() + "/user/ticketComments"+id,
        type: "GET",
        headers: {
        ...
        success: (data, textStatus, jqXHR) => { 
            ...
            {
                status =  `<span class="current">Closed</span>`;
                $('.closedticket').hide();
            }
            else
            {
                status = `<span class="current">Closed No Response</span>`;
                $('.closedticket').hide();
            }
    ...
    $('body').on('click', '.status_enable', function() {
        ...
        var url = getBaseUrl() + "/user/tickets/"+id+'/updateStatus?status='+value;
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                hideInlineLoader();
                setTimeout(function(){
                window.location.replace("{{ url('/view-tickets/') }}/"+id);
                }, 1000);
            },
       ...
       messages: {
        ...
        success: function(label) {
         ...
         submitHandler: function (form) {
            ...
            $.ajax({
                url: getBaseUrl() + "/user/newcomment",
                type: "post",
                data: data,
                processData: false,
                contentType: false,
