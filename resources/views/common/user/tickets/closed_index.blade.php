...
<section class="content-box ticketContentBox" id="Contact">
    ...
    <div class="container">
        <div class="ticketMenu">
            <ul>
                <li><a  href="{{ url('/tickets') }}">Open Tickets</a></li>
                <li><a class="active" href="{{ url('/closed-tickets') }}">Closed Tickets</a></li>
                <li class="createBtn"><a class="btn btn-primary" href="{{ url('/new-tickets') }}">Create New Ticket</a></li>
            </ul>
        </div>
...
$(document).ready(function() {
    table = table.DataTable( {
        ...
        "ajax": {
            "url": getBaseUrl() + "/user/closed_tickets?&type=USER",
            "type": "GET",
        ...
        "columns": [
            ...
            { "data": "title" ,render: function (data, type, row) {
               return `<a href="{{ url('/view-tickets/`+row.id+`') }}"><p class="ticName"> [#`+row.ticket_id+`] ` +row.title+`</p></a>`;
               }
            },
            { "data": "created_at" },
