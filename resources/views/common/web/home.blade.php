...
<section id="home" class="top-section dis-center">
    <div class="background-holder background-holder--auto background-holder--left-top d-none d-lg-block d-xl-block " style="background-image:  url(assets/layout/images/common/go_x_bg.png); background-repeat: no-repeat; background-size: 100%;">
