            ...
            <div class="col-lg-12 col-md-12 col-sm-12 dis-row p-0">
                ...
                <div class=" col-md-7 p-0 user float-right p-0">
                    <ul class="w-100 dis-flex-end m-0">
                        ...
                        <li class="menu-item d-lg-block d-xl-block user_login "><a class="btn-green-secondary" href="{{URL::to('/home')}}">{{ __('Login as Guest') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="provider-section bg-green">
                        ...
                        <div class="dis-column">
                            <a class="btn big-btn shop_app" href="{{URL::to('shop')}}">Shop App <i class="fa fa-arrow-circle-right ml-2"
                                    aria-hidden="true"></i></a>
                            <a class="btn big-btn shop_login" href="{{URL::to('shop')}}">Shop Sign In <i class="fa fa-arrow-circle-right ml-2"
                                    aria-hidden="true"></i></a>
                        </div>
                    </div>
                </li>
