            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
               ...
               <div class="mytrip-right my_trips">
                  <div class="fare-break ">
                     <h5 >@lang('transport.user.distance_travelled') <span>
                         <span class ="distance_unit"></span><span class ="distance_travelled"></span>  
                        </span>
                     </h5>
                     ...
                     <h5 id="distance_fare"> <p class="distance_fare_text"></p><span>
                        <span class ="distance_fare"></span>  <span class ="currency"></span>
                        </span>
                     </h5>
                     <h5 id="time_fare"><p class="time_fare_text"></p><span>
                         <span class ="minute_fare"></span>  <span class ="currency"></span>
                        </span>
                     </h5>
                     <h5 id="waiting_fare">@lang('transport.user.waiting_fare') <span>
                         <span class ="waiting_fare"></span>  <span class ="currency"></span>
                        </span>
                     </h5>
                     <h5 id="toll_charges"><strong>@lang('transport.user.toll_charges')</strong><span><strong></strong>
                     ...
                     <h5 id="promocode"><strong>@lang('service.user.promocode_discount')</strong><span><strong>
                         </span>  <span class ="promocode"></span>  <span class ="currency"></span>
                        </strong></span>
                    </h5>
                     <h5 id="wallet"><strong>@lang('user.ride.detection_wallet')</strong><span><strong>
               ...
               <div class="menu-item menu-one ">
                  ...
                  @elseif($service =='DELIVERY')
                     <a  class="dis-column" href="{{ url('/delivery/trips') }}">
                        <div class="dis-center"><i class="material-icons">redeem</i></div>
                        <span class ="order-detail">Delivery</span>
                     </a>
      ...
      $.ajax({
         ...
         success:function(data){
            ...
            $.each(result,function(key,item){
               ...
               if(paymentNode != null){
               $('#distance_fare,#time_fare,#waiting_fare,#wallet,#promocode,#toll_charges').show();
               
               $('.distance_travelled').text(result.total_distance);
               $('.distance_unit').text(result.unit);
               $('.base_fare_text').text(result.payment.base_fare_text);
               $('.base_fare').text(result.payment.fixed.toFixed(2));
               if(result.payment.distance)
               {
        ...
        "columns": [
         { "data": "id" ,render: function (data, type, row, meta) {
            ...
            { "data": "provider_id" ,render: function (data, type, row) {
               ...
               if(row.payment && row.payment.is_partial != 1 && row.payment.wallet > 0)
               {
                  return 'WALLET';
               }
               else{
