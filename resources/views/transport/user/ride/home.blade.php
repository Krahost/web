            ...
            success: (data, textStatus, jqXHR) => {
               ...
               if((Object.keys(data.responseData)).length > 0) {
                  ...
                  if(result.fare.time != "") {
                   ...
                   if(result.fare.base_price != "") {
                     estimationHtml += `<li>
                                          <span class="fare">Base Fare</span>
                                          <span class="pricing "><span> `+result.currency+`</span><span class="base_amount">`+result.fare.base_price+`</span></span>
                                       </li>`;
                  }
                   if(result.fare.tax_price != "") {
                     estimationHtml += `<li>
                                          <span class="fare">Tax Fare</span>
                                          <span class="pricing "><span> `+result.currency+`</span><span class="tax_amount">`+result.fare.tax_price+`</span></span>
                                       </li>`;
                  }
                  if(result.fare.peak != "" && result.fare.peak >0) {
                     estimationHtml += `<li>
                                          <span class="fare">Peak Charge</span>
                                          <span class="pricing">`+result.fare.peak_percentage+`</span>
                                       </li>`;
                  }

                  if(result.fare.coupon_amount != "") {
                        estimationHtml += `<li class="promocode_container">
                           ...
                           <span class="txt-green pricing "><span>`+result.currency+`</span><span class="coupon_value">`+result.fare.coupon_amount+`</span></span>
                        </li>`;
                  }
