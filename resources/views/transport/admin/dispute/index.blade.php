        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    ...
                    @permission('ride-dispute-create')
                ...
                <thead>
                    <tr>
                            ...
                            @permission('ride-dispute-status')                   
        ...
        "columns": [
            ...
            { "data": "id", render: function (data, type, row) {
                ...
                var button='<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button>'+
                   ...
                   button +='@permission('ride-dispute-edit')<li><a href="javascript:;" data-id="'+data+'" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li>@endpermission @permission('ride-dispute-delete')<li><a href="javascript:;" data-id="'+data+'" class="dropdown-item delete"><i class="fa fa-trash"></i>&nbsp;Delete</a> </li>@endpermission';
