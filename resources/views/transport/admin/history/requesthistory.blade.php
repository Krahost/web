...
$(document).ready(function() {
    ...
    table = table.DataTable( {
        ...
        "serverSide": true,
        "ajax": {
            "url": getBaseUrl() + "/admin/requesthistory",
            "type": "GET",
        ...
        "columns": [
            ...
            { "data": "id", render: function (data, type, row) {
                return "@permission('ride-request-history-view')<button data-id='"+data+"' class='btn btn-block btn-success view'>view</button>@endpermission";
            }}
